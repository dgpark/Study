...
public:
	void readInput();
	void swap(int **gred1, int **gred2);
	void partition(int **gred1, int left, int right, int& pivot);
	void quickSort(int ** gred1, int left, int right);	
...
void Diet::swap(int **gred1, int**gred2){
	int temp[6] = {0};
...
void Diet::partition(int **gred1, int left, int right, int &pivot){
	int i,j;
	int pivotItem;
...
void Diet::quickSort(int **gred1, int left, int right){
	int pivot;
